...
**Статус:** рабочая версия; последняя принятая версия после ручного пользовательского теста — `v2.1.0`
...
Изменения текущей рабочей версии описаны в [`versions/v2.1.1.md`](versions/v2.1.1.md).
Изменения текущей принятой версии описаны в [`versions/v2.1.0.md`](versions/v2.1.0.md).
