...
- Отдельное окно `Точки из Excel` внутри приложения: загрузка sample-first `.xlsx`, preview точек и ошибок по строкам, настройка цвета/прозрачности и экспорт point-KML без смешивания с grid-flow.
...
Изменения текущей принятой версии описаны в [`versions/v2.0.3.md`](versions/v2.0.3.md).
