...
- левая панель: координаты, параметры сетки, схема нумерации, имена квадратов, стиль KML, экспорт;
- правая панель: вкладки `Предпросмотр` и `Проверка`;
...
- [`versions/v0.5.0.md`](versions/v0.5.0.md) — описание текущей версии.
...
Текущая принятая версия: `v0.5.0`.

Изменения версии описаны в [`versions/v0.5.0.md`](versions/v0.5.0.md).
