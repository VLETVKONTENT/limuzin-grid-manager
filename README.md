...
**Статус:** принятая версия после ручного пользовательского теста — `v2.1.2`
...
Изменения текущей рабочей версии описаны в [`versions/v2.1.2.md`](versions/v2.1.2.md).
Изменения текущей принятой версии описаны в [`versions/v2.1.2.md`](versions/v2.1.2.md).
