...
- [`versions/v2.0.2.md`](versions/v2.0.2.md) — заметки текущей принятой версии.
...
Изменения текущей принятой версии описаны в [`versions/v2.0.2.md`](versions/v2.0.2.md).
