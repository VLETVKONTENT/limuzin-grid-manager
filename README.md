...
- автоматического разбиения области по зонам в `v1.2.0` нет;
...
Для `v1.2.0` проверено:

- `55 passed`;
- компиляция `src` и `tests` без ошибок;
- SVG/GeoJSON/CSV-экспорт, `export_format_id` и вкладка `Экспорт` покрыты автотестами;
- EXE собран с `FileVersion` и `ProductVersion` `1.2.0.0`;
...
- [`versions/v1.2.0.md`](versions/v1.2.0.md) — заметки текущей версии.
...
Изменения версии описаны в [`versions/v1.2.0.md`](versions/v1.2.0.md).
