...
Для `v1.5.0` проверено перед ручным тестом:
...
- EXE собран с `FileVersion` и `ProductVersion` `1.5.0.0`;
...
- [`versions/v1.5.0.md`](versions/v1.5.0.md) — заметки текущей версии.
...
Изменения версии описаны в [`versions/v1.5.0.md`](versions/v1.5.0.md).
