...
- [`versions/v0.6.0.md`](versions/v0.6.0.md) — описание текущей версии.
...
Текущая принятая версия: `v0.6.0`.

Изменения версии описаны в [`versions/v0.6.0.md`](versions/v0.6.0.md).
