...
- Видимость: готовится к публичному репозиторию; последняя принятая версия `v1.1.0`.
- Основная ветка: `main`.
...
- Последняя подготовленная версия: `v1.1.0`.
- Последний опубликованный release после публикации: https://github.com/VLETVKONTENT/limuzin-grid-manager/releases/tag/v1.1.0
- Предыдущий опубликованный release: https://github.com/VLETVKONTENT/limuzin-grid-manager/releases/tag/v1.0.0
