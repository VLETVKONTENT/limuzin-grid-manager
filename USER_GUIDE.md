...
Для контрольной проверки `v2.1.4` вручную проверьте:
...
- если вы готовите публичный релиз, проверьте в GitHub Actions, что workflow `CI` завершился успешно и workflow `Release Windows EXE` собрал артефакт `LIMUZIN_GRID_MANAGER.exe`.
