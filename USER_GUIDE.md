...
Для ZIP должна быть включена сетка `1000x1000`. SVG сохраняется одним файлом с метрическим `viewBox`, слоями `1000x1000` и `100x100`, подписями и техническими `data-*` атрибутами. Во вкладке видно путь результата, количество объектов выбранного формата, примерный размер и состав ZIP или SVG.
...
Для контрольной проверки `v1.1.0` вручную проверьте:
